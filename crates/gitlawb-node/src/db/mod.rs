...
const MIGRATIONS: &[Migration] = &[
    ...
    // Arweave anchoring (#26).  Numbered 18/19: versions 12–16 are claimed by
    // other in-flight branches, and main's current max is 17.  The runner keys
    // the applied set on the integer alone, so gaps are harmless.
    Migration {
        version: 18,
